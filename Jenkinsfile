pipeline{
    ...
    post{
        ...
        unsuccessful{
            emailext attachLog: true, body: '', subject: 'Build $BUILD_NUMBER has failed', to: 'henrique.galli@atomicsolutions.com.br'
        }
        fixed{
            emailext attachLog: true, body: '', subject: 'Build is fixed', to: 'henrique.galli@atomicsolutions.com.br'
        }
    }
}
